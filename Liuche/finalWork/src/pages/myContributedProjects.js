...
import {getProjectMessage, getProjectNum, timestamp2Time, isMyContribution, isMyProject} from "../communicationWithContracts/communicationWithContracts";
const{Meta}=Card;
class myContributedProjects extends React.Component{
    constructor(props) {
        super(props);
        this.state={
            allprojects:[],
    ...
    async componentDidMount() {
        ...
        for(var i=0;i<projectNum;i++){
            let ismy=await isMyContribution(i);
            if(ismy===true){
...
export default myContributedProjects;